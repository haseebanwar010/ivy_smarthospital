...
<html lang="en">
    <head>
        ...
        <link href="<?php echo base_url(); ?>backend/images/favi.ico" rel="shortcut icon" type="image/x-icon">
        ...
        <style type="text/css">
            ...
            .customize_btn_login:hover{
                background: rgb(57,181,74) !important;
                background: linear-gradient(90deg, rgba(57,181,74,0.9) 0%, rgba(27,117,188,0.9) 100%) !important;
            }
            .backstretch
            {
            ...
            body{
                ...
                background: linear-gradient(90deg, rgba(57,181,74,0.9) 0%, rgba(27,117,188,0.9) 100%);
            }
            .logowidth{
                max-width: 50%;
                height: auto;
                        ...
                        <div class="col-lg-5 col-sm-5 <?php echo $offset; ?> form-box">
                            <div class="loginbg">
                                ...
                                <div class="form-bottom">
                                    <!-- <h3 class="font-white" style="color: #000 !important;"><?php echo $this->lang->line('user_login'); ?></h3> -->
                                    <?php
                                    ...
                                    <form action="<?php echo site_url('site/userlogin') ?>" method="post">
                                        ...
                                        <!-- <br> -->
                                        <button type="submit" class="btn customize_btn_login">
