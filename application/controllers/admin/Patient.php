...
class patient extends Admin_Controller {
    ...
    public function addpatient() {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            // $teacher_login_detail = array('id' => $insert_id, 'credential_for' => 'patient', 'username' => $this->input->post('email'), 'password' => $user_password, 'contact_no' => $this->input->post('mobileno'), 'email' => $this->input->post('email'));
