...
<!--                     <div class="row">
                        <div class="col-sm-8 col-sm-offset-2 text">
                            ...
                            <img src="<?php echo base_url(); ?>backend/images/s_logo.png" class="logowidth"> ye comment he ho ga...
                                    ...
                                    <form class="" action="<?php echo site_url('site/ufpassword') ?>" method="post">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <span style="float: right;">
                                                <a href="<?php echo site_url('site/userlogin') ?>" class="forgot"><i class="fa fa-key"></i> <?php echo $this->lang->line('user_login'); ?>
                                                </a>
                                            </span>
