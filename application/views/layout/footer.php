...
<!--     &copy;  <?php echo date('Y'); ?> 
    <?php echo $this->customlib->getAppName(); ?> <?php echo $this->customlib->getAppVersion(); ?> -->
      ...
      <a href="https://www.ivylabtech.com/" target="_blank" style="display: inline;"><img src="<?php echo base_url();?>uploads/footer/logo.png" style="width: 5%; float: left; padding-bottom: 10px;"></a><span style="color: #0073ac; float: left; font-size: 12px;">&nbsp;&nbsp;&nbsp; <strong>Ivy Smart Medic</strong></span>

    <div style="float: right; font-size: 12px;">
        <?php echo date('Y'); ?> &copy; &nbsp;
        <a href="https://www.ivylabtech.com/" target="_blank" style="float: right;">ivylabtechnologies</a>
    </div>
</footer>
